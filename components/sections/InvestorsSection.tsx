...
const INVESTORS: Investor[] = [
  {
    ...
    focus: ["AgriTech", "EdTech", "Rural SaaS"],
    totalDeals: 34,
    portfolioSize: "₹120Cr",
    initials: "RM",
    avatarColor: "#f59e0b",
  ...
  },
  {
    ...
    focus: ["CleanTech", "LogiTech", "AgriTech"],
    totalDeals: 18,
    portfolioSize: "₹60Cr",
    initials: "AS",
    avatarColor: "#34d399",
  ...
  },
  {
    ...
    firm: "South Ventures",
    role: "Angel Investor",
    focus: ["HealthTech", "CleanTech", "AI/ML"],
    totalDeals: 15,
    portfolioSize: "₹45Cr",
    initials: "KR",
    avatarColor: "#a78bfa",
  ...
  return (
    <section id="investors" className="py-24 lg:py-28 bg-[#0a0a0f] relative">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        >
          120+ investors actively deploying into startups from Tier-2 and Tier-3
          cities. Real check-writers, not just advisors.
        </motion.p>
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5 mb-4">
                {investor.focus.map((tag) => (
                  <span
                    key={tag}
                    className="text-[10px] font-mono uppercase tracking-wider px-2.5 py-1 rounded-full border border-white/[0.06] bg-white/[0.02] text-white/30"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="flex items-center justify-between pt-3 border-t border-white/[0.04]">
                <div className="flex items-center gap-4">
                  <div>
                    <span className="text-xs text-white/20 block">
                      Portfolio
                    </span>
